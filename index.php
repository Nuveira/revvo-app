        ...
        <div class="max-w-4xl">
            ...
            <div class="space-y-8" style="animation: fadeInUp 0.8s ease-out 0.6s both;">
                ...
                <div class="flex flex-row gap-4">
                    <a href="<?= url('pages/auth/login.php') ?>" class="bg-white text-stone-900 px-10 py-5 rounded-xl font-bold text-sm uppercase tracking-widest shadow-xl hover:bg-stone-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 mechanical-press inline-block">Daftar Demo</a>
        ...
        <div class="animate-on-scroll scale-in mesh-gradient-red p-16 md:p-24 rounded-[3rem] text-center shadow-2xl relative overflow-hidden group">
            ...
            <div class="relative z-10">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-6 items-center">
                    <a href="<?= url('pages/auth/login.php') ?>" class="bg-stone-900 text-white px-12 py-6 rounded-2xl font-bold uppercase tracking-widest shadow-2xl hover:scale-105 hover:shadow-[0_20px_60px_rgba(0,0,0,0.4)] transition-all duration-300 mechanical-press inline-block pulse-glow">Coba Demo Sekarang</a>
