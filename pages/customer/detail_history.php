...
$pageTitle = 'Detail History | REVVO';
...
// Ambil spare parts yang digunakan
$parts = [];
$stmt = $conn->prepare("
...
<body class="font-['Plus_Jakarta_Sans'] flex h-screen overflow-hidden">
    ...
    <div class="flex-1 bg-gray-100 overflow-y-auto overflow-x-hidden">
        ...
        <div class="bg-gradient-to-r from-black via-black via-20% to-[#8E1616] flex flex-col gap-4 p-5 md:flex-row md:items-center md:justify-between">
            ...
            <a href="history.php" class="bg-[#FF0000] px-4 py-3 rounded text-sm font-semibold text-white whitespace-nowrap hover:bg-[#6e1111] transition inline-flex items-center gap-2 shadow-[0_0_15px_rgba(142,22,22,0.3)] shadow-red-500/40">
