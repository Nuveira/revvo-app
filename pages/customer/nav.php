<body>
    <div class="h-screen w-64 bg-[#8E1616] text-white flex flex-col">
            <div class="flex flex-col pt-6 gap-2 px-6"> 
                <p class="text-white">PP</p>
                <P class="text-white">Geral maulana</P>
                ...
                <nav class="flex flex-col gap-2 px-6 py-4">
                    ...
                    <a href="motorsaya.php" class="inline-block text-white py-2 px-4 hover:bg-[#1D1616] rounded">Motor Saya</a>
